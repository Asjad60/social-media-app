      ...
      <div className="p-4">
        <div className="flex justify-between">
          ...
          <Btn
            ...
            notPadding={true}
            customClass={"items-start justify-start mt-1 hover:text-purple-600"}
            bg={"none"}
          >
            <X size={25} />
          </Btn>
        ...
        <nav className="space-y-2">
          ...
          <button
            ...
            className={
              "flex w-full cursor-pointer justify-start px-4 py-3 gap-4 text-gray-300 hover:bg-gray-50 hover:text-gray-800 rounded-lg transition-colors duration-150"
            }
          >
